...
class CliniCalSupabaseUser extends BaseAuthUser {
  CliniCalSupabaseUser(this.user);
  User? user;
  @override
...
Stream<BaseAuthUser> cliniCalSupabaseUserStream() {
  ...
  return (!loggedIn
      ...
      .map<BaseAuthUser>(
    (authState) {
      currentUser = CliniCalSupabaseUser(authState?.session?.user);
      return currentUser!;
    },
  );
}
